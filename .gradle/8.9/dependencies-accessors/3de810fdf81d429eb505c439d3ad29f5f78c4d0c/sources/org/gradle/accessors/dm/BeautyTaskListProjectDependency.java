...
@NonNullApi
public class BeautyTaskListProjectDependency extends DelegatingProjectDependency {

    @Inject
    public BeautyTaskListProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
